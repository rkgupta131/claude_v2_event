...
async def unified_stream_get(
    ...
    model_family: ModelFamily = Query(ModelFamily.ANTHROPIC, description="AI provider"),
    model_name: str = Query("claude-opus-4-5-20251101", description="Specific model name"),
